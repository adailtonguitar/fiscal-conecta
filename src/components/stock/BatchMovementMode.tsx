    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-semibold text-foreground">Modo Movimentações</h2>
          {pendingCount > 0 && (
                ...
                return (
                  <tr
                    ...
                    className={`border-b border-border last:border-0 transition-colors ${
                      isChanged ? "bg-primary/5" : "hover:bg-muted/50"
                    }`}
                  >
                      ...
                      <>
                        ...
                        <td className="px-4 py-2.5">
                          <Input
                            ...
                            value={stockEntry?.reference || ""}
                            onChange={(e) => updateStockEntry(product.id, "reference", e.target.value)}
                          />
                        </td>
                      </>
                    ) : (
                      <>
                        ...
                        <td className="px-4 py-2.5">
                          <Input
                            ...
                            onChange={(e) => updatePriceEntry(product.id, "price", e.target.value)}
                          />
                        </td>
                        ...
                        <td className="px-4 py-2.5">
                          <Input
                            ...
                            step="0.01"
                            min="0"
                            placeholder={(product.cost_price ?? 0).toString()}
                            className="w-28 mx-auto text-center h-8"
                            value={priceEntry?.cost_price ?? ""}
                            onChange={(e) => updatePriceEntry(product.id, "cost_price", e.target.value)}
                          />
                        </td>
                      </>
                    )}

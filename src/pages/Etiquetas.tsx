...
export default function Etiquetas() {
  ...
  const handlePrintDone = (ids: string[]) => {
    ...
    <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 justify-between">
            <Tabs value={tab} onValueChange={(v) => { setTab(v as any); setSelected(new Set()); }}>
              <TabsList>
                ...
                <TabsTrigger value="impressa">Impressas</TabsTrigger>
                ...
                {filtered.map((label) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Badge variant={label.status === "pendente" ? "destructive" : "secondary"} className="text-xs">
                        {label.status === "pendente" ? "Pendente" : "Impressa"}
                      </Badge>
                    </div>
                  );
                })}
      ...
      {selectedLabels.length > 0 && (
        <Card>
          ...
          <CardContent>
            <LabelPreview labels={selectedLabels} onPrintDone={handlePrintDone} />
          </CardContent>
        </Card>
      )}
    </div>

                        ...
                        isNfceEmitida ? (
                          ...
                          <>
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-primary text-primary-foreground text-[10px] font-medium hover:opacity-90 transition-all"
                            >

import { TrendingUp, ShoppingBag, DollarSign, AlertTriangle, ArrowUpRight, ArrowDownRight, Clock, Shield, Heart, Target } from "lucide-react";
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {stats.fiscalProtected ? "Escudo Fiscal ativo" : "Ative o Modo Seguro Fiscal"}
                  </p>
                </div>
              </div>
            </motion.div>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {stats.recentSales.length === 0 ? (
                    <tr>
                      <td colSpan={4} className="px-5 py-8 text-center text-muted-foreground">Nenhuma venda registrada</td>
                    </tr>
                  ) : (
